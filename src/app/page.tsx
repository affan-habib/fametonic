    ...
    <div className="relative w-full min-h-screen bg-[#010101]">
      ...
      <div className="absolute w-full min-h-[724px] top-[81px] left-0">
        ...
        <nav className="flex w-full items-center justify-center md:justify-between px-4 md:px-[211px] py-0 absolute top-0 left-0">
          ...
          <button className="md:hidden absolute right-4 top-1/2 transform -translate-y-1/2">
            <svg width="20" height="15" viewBox="0 0 20 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="1" y1="1.03597" x2="19" y2="1.03597" stroke="white" strokeWidth="2" strokeLinecap="round"/>
              <line x1="1" y1="7.03597" x2="19" y2="7.03597" stroke="white" strokeWidth="2" strokeLinecap="round"/>
              <line x1="1" y1="13.036" x2="19" y2="13.036" stroke="white" strokeWidth="2" strokeLinecap="round"/>
            </svg>
          </button>
        </nav>
